...
(1, 'Rene', 'adfds@fds', '123'),
(2, 'Vova', 'rerew@fdsfds', '453');
...
(1, 'Lev', 'Valge', '2006-04-19', NULL, '1424342', 'Tallinn, Läänemre tee 35', 5.0, NULL);
...
(1, '2026-04-07', 'Andmebaasid', 1, 5),
(2, '2026-04-10', 'matemaatika', 1, 5);
...
CREATE TABLE `tund` (
  ...
  `kuupaev` date DEFAULT NULL,
  `tundnimi` varchar(50) DEFAULT NULL,
